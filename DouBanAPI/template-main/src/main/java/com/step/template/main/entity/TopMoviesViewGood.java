...
/**
 * 
 * @TableName top_movies_view_good
 */
@TableName(value ="top_movies_view_good")
@Data
public class TopMoviesViewGood implements Serializable {
    /**
     * 
     */
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        TopMoviesViewGood other = (TopMoviesViewGood) that;
